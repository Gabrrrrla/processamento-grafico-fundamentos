...
**Processamento Gráfico: Fundamentos** ministrada pela prof **Rossana Baptista Queiroz**
...
│       ├── Lista1/
        ├── Lista2/
├── Trabalho GA/     # Jogo 2D desenvolvido como trabalho do GA  
├── Trabalho GB/     # Editor de fotos e vídeos como trabalho do GB   
...
* Para os projetos principais: utilize a pasta `TrabalhoGA/` ou `TrabalhoGB/`.
...
Todos os exercícios e trabalhos foram desenvolvidos por mim.
